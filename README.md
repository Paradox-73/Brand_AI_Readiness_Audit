...
![Tests](https://img.shields.io/badge/Tests-649%20passing-2EA043?style=flat-square)
...
```bash
pip install pytest
python3 -m pytest -q                        # 649 tests, about 16 minutes
python3 -m pytest -q -m "not mutation"      # 592 tests, about 4 minutes
```
